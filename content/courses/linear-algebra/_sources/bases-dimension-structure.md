# Sources - Bases and dimension

## Math and history
- MacTutor Emmy Noether: https://mathshistory.st-andrews.ac.uk/Biographies/Noether_Emmy/
- Linear independence, basis, dimension theorems (standard linear algebra).
...
- Expanded to personal-KB chapter structure on independence, bases, dimension, rank, change-of-basis, PCA ethic.
- estimatedMinutes bumped into 60-75 range.
- Verified hooks: Emmy Noether (MacTutor), Strogatz "Group Think" as sibling structure idea, Algebrica vector spaces.
