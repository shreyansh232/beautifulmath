# Sources - Matrices as maps

## Math and history
- MacTutor Cayley; matrix algebra: https://mathshistory.st-andrews.ac.uk/Biographies/Cayley/
- Linearity definition; columns as images of basis (3Blue1Brown / Axler-style intuition).
...
- Used: 'Untangling the Web' PageRank / link-matrix story.
- Attribute as popular exposition / pedagogy, not primary historical scholarship.

## Algebrica
- Algebrica (Antonio Lupetti), open math knowledge base with SVG diagrams: https://algebrica.org/linear-maps/
...
- Expanded to personal-KB chapter structure on linearity, columns-as-images, composition, affine honesty, PageRank as pedagogy.
- estimatedMinutes bumped into 60-75 range.
- Verified hooks: Cayley (MacTutor), Strogatz "Untangling the Web" as popular exposition of PageRank, Algebrica linear maps.
